function createFooter() {
  ...
  const sections = [
    { title: 'Vini bianchi', links: [{ text: 'Pecorino', href: 'pecorino.html' }, { text: 'Chardonnay', href: 'chardonnay.html' }, { text: 'Cococciola', href: 'cococciola.html' }] },
    { title: 'Vini rossi', links: [{ text: 'Montepulciano rosso', href: 'montepulciano.html' }, { text: 'Montepulciano rosso Bio', href: 'montepulciano_bio.html' }] },
    { title: 'Vini Rosati', links: [{ text: 'Montepulciano Cerasuolo', href: 'cerasuolo.html' }] },
    { title: 'Spumanti', links: [{ text: 'Cococciola spumante brut', href: 'cococciola_spumante.html' }, { text: 'rose spumante brut', href: 'rose_brut.html' }, { text: 'rose spumante brut Bio', href: 'rose_brut_bio.html' }] },
    { title: 'Dolci', links: [{ text: 'Moscato dolce', href: 'moscato.html' }, { text: 'Moscato dolce Bio', href: 'moscato_bio.html' }] }
  ];
